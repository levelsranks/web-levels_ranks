...
<div class="back">
    ...
    <form enctype="multipart/form-data" method="post">
        <div class="db_left">
            ...
            <div class="input-form"><div class="input_text">USER</div><input name="USER" value="<?php ! empty( $_POST['USER'] ) && print $_POST['USER']?>"></div>
        ...
        <div class="db_right">
                ...
                <?php if( ! empty( $db_check ) && $db_check == 1):?><div class="sidebar_name ERROR"><?php echo $options['language'] == 'EN' ? 'NO CONNECTION TO YOUR BASE OR NO TABLE' : 'НЕТУ ПОДКЛЮЧЕНИЯ К ВАШЕЙ БАЗЕ ИЛИ НЕТУ ТАБЛИЦЫ'?></div><?php endif?>
        </div>
    </form>
</div>