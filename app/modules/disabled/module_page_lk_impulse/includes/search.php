...
<div class="col-md-7">
        <div class="card">
            <div class="card-header">
                <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_lk_impulse','_SearchStatus')?></h5>
            </div>
            <div class="card-container">
            <?php if(empty($_SESSION['search'])):?>
            	<?php echo $Translate->get_translate_module_phrase('module_page_lk_impulse','_Noresult')?>
            <?php else:?>
                ...
                <?php if(sizeof($_SESSION['search']) >6): $Translate->get_translate_module_phrase('module_page_lk_impulse','_maxResult'); endif?>
            <?php endif;?>
            </div>
        </div>
    </div>
