    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="badge">Топ донатеров</h5>
            </div>
            <table class="table table-hover">
                ...
                <tbody><?php for ( $sz_i = 0, $sz = sizeof( $res ); $sz_i < $sz; $sz_i++ ):
                    ...
                    <tr class="pointer"
                        <?php if ( $Modules->array_modules['module_page_profiles']['setting']['status'] == '1'){ ?>onclick="location.href = '<?php echo $General->arr_general['site'] ?>?page=profiles&profile=<?php print $General->arr_general['only_steam_64'] === 1 ? con_steam32to64( $res[$sz_i]['auth'] ) : $res[$sz_i]['auth']?>&server_group=<?php echo $server_group ?>';"<?php } ?>>
