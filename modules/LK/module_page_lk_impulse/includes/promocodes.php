...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SettingsPromo')?></h5>
        </div>
        <div class="card-container">
                  <table class="table table-hover">
                <thead>
                <tr>
                    <th><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Promo')?></th>
                    <th><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_BonusPromo')?></th>
                    <th><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_LimitUsePromo')?></th>
                    <th><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Snap')?></th>
                    <th><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Options')?></th>
                </tr>
            </thead>
             <tbody>
    ...
    <div class="card">
        ...
        <div class="card-container">
             <div class="select-panel">
               <a class="btn" href="<?php echo set_url_section(get_url(2), 'promocode_add', 'promocodes') ?>"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddPromocode')?></a></option>
            </div>
        </div>
        </div>
    </div>
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_EditPromo')?> - <?php echo $promo[0]['code']?></h5>
        ...
        <div class="card-container module_block">
            <form id="promocode_edit" data-default="true" enctype="multipart/form-data" method="post">
                    ...
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Name')?>:</div><input name="editpromo" value="<?php echo $promo[0]['code']?>" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_LimitUsePromo')?>:</div><input name="editlimit" value="<?php echo $promo[0]['attempts']?>" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_BonusPromo')?>:</div><input name="editbonuspecent" value="<?php echo $promo[0]['percent']?>" ></div>
                   <div class="input-form">
                        <input class="border-checkbox" type="checkbox" name="status" id="status" <?php $promo[0]['auth1'] && print 'checked';?>>
                        <label class="border-checkbox-label" for="status"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SnapSID')?></label>
                    </div>
             </form>
            <input class="btn"  type="submit" form="promocode_edit" value="<?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Save')?>">
            ...
            <div class="user_pays">
                ...
                <?php else:?>
                    <?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse', '_PromoNotUse') ?>
                <?php endif?>    
            </div>
        </div>
    </div>
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddPromocode')?></h5>
        ...
        <div class="card-container module_block">
            <form id="promocode_add" data-default="true" enctype="multipart/form-data" method="post">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddPromoName')?></div><input name="addpromo" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_LimitUsePromo')?>:</div><input name="limit" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_BonusPromo')?>:</div><input name="bonuspecent"></div>
                    <div class="input-form">
                        <input class="border-checkbox" type="checkbox" name="auth" id="status_add">
                        <label class="border-checkbox-label" for="status_add"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SnapSID')?></label>
                    </div>           
             </form>
            <input class="btn" name="promocode_add" type="submit" form="promocode_add" value="<?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddPromocode')?>">
        </div>
    </div>
</div>
<?php endif?>