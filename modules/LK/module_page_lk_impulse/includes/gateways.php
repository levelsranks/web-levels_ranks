...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SettingsGateways')?></h5>
            <div style="float: right;position: relative;top: 30px;right: 25px;"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse', '_BalanceAllTime') ?>:
             <?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AmountCourse').$LK->LkAllDonats()?></div>
        </div>
                        ...
                        <?php foreach($LK->LkGetAllGateways() as $key):
                            ...
                            <li class="dd-item" >
                                ...
                                <div class="dd-handle"><?php echo $key['name_kassa'];?>
                                    <div style="float: right;"><small><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AmountCourse').$LK->LkAllDonatsToPayGateway(mb_strtolower($key['name_kassa']));?></small></div>
                                </div>
                            </li>
                        <?php endforeach?>
                    </ol>
        ...
        <div class="card-container">
             <div class="select-panel badge">
                <select onChange="window.location.href=this.value">
                	 <option value="" disabled selected><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddGateways')?></option>
            ...
            <div style="padding-top:15px;">
                <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_DiscordMessage')?></h5>
                ...
                <input class="btn"  type="submit" form="webhook_discord" value="<?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Save')?>">
            </div>
        </div>
        </div>
    </div>
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SetGateways')?> - <?php echo ucfirst($_GET['geteway_edit'])?></h5>
        ...
        <div class="card-container module_block">
            ...
            <?php switch ($_GET['geteway_edit']):
                ...
                case 'yandexmoney':?>
                    <input type="hidden" name="gateway_edit" value="<?php echo $_GET['geteway_edit']?>">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Purse')?></div><input name="shopid" value="<?php echo $Gateway[0]['shop_id']?>" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?></div><input name="secret2" value="<?php echo $Gateway[0]['secret_key_2']?> "></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway=yandexmoney</div></div>
                     <div class="input-form">
                        <input class="border-checkbox" type="checkbox" name="status" id="status" <?php $Gateway[0]['status'] && print 'checked';?>>
                        <label class="border-checkbox-label" for="status"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ActGateways')?></label>
                    </div>
                <?php break; 
                 case 'qiwi':?>
                    <input type="hidden" name="gateway_edit" value="<?php echo $_GET['geteway_edit']?>">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_PublicKey')?>:</div><input name="secret1" value="<?php echo $Gateway[0]['secret_key_1']?>"></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SecretKey')?>:</div><input name="secret2" value="<?php echo $Gateway[0]['secret_key_2']?>"></div>
                   <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway=qiwi</div></div>
                    <div class="input-form">
		                <input class="border-checkbox" type="checkbox" name="status" id="status" <?php $Gateway[0]['status'] && print 'checked';?>>
		                <label class="border-checkbox-label" for="status"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ActGateways')?></label>
		            </div>
                ...
                <?php break; 
                  case 'robokassa':?>
                    <input type="hidden" name="gateway_edit" value="<?php echo $_GET['geteway_edit']?>">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Indetificator')?></div><input name="shopid" value="<?php echo $Gateway[0]['shop_id']?>"></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?> #1</div><input name="secret1" value="<?php echo $Gateway[0]['secret_key_1']?>"></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?> #2</div><input name="secret2" value="<?php echo $Gateway[0]['secret_key_2']?>"></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway =robokassa</div></div>
                   <div class="input-form">
		                <input class="border-checkbox" type="checkbox" name="status" id="status" <?php $Gateway[0]['status'] && print 'checked';?>>
		                <label class="border-checkbox-label" for="status"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ActGateways')?></label>
		            </div>
                <?php break; 
                 case 'freekassa':?>
                    ...
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?> #1</div><input name="secret1" value="<?php echo $Gateway[0]['secret_key_1']?>"></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?> #2</div><input name="secret2" value="<?php echo $Gateway[0]['secret_key_2']?>"></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway=freekassa</div></div>
                   <div class="input-form">
                        <input class="border-checkbox" type="checkbox" name="status" id="status" <?php $Gateway[0]['status'] && print 'checked';?>>
                        <label class="border-checkbox-label" for="status"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ActGateways')?></label>
                    </div>
            ...
            <input class="btn"  type="submit" form="gateway_edit" value="<?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Save')?>">
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddGateways')?> - <?php echo ucfirst($_GET['gateway_add'])?></h5>
        ...
        <div class="card-container module_block">
            ...
            <?php switch ($_GET['gateway_add']):
                case 'webmoney':?>
                    ...
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Purse')?></div><input name="shopid" ></div>
                ...
                case 'yandexmoney':?>
                    <input type="hidden" name="gateway" value="<?php echo $_GET['gateway_add']?>">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Purse')?></div><input name="shopid" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?></div><input name="secret2" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway=yandexmoney</div></div>
                ...
                <?php break; 
                 ...
                 case 'interkassa':?>
                    <input type="hidden" name="gateway" value="<?php echo $_GET['gateway_add']?>">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Indetificator')?></div><input name="shopid" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_SecretKey')?>:</div><input name="secret2" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway=interkassa</div></div>
                ...
                <?php break; 
                  case 'robokassa':?>
                    <input type="hidden" name="gateway" value="<?php echo $_GET['gateway_add']?>">
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Indetificator')?></div><input name="shopid" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?> #1</div><input name="secret1" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_Password')?> #2</div><input name="secret2" ></div>
                    <div class="input-form"><div class="input_text"><?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_ResultUrl')?></div><div><?php echo $LK->https().get_url(2)?>?page=lk&gateway=robokassa</div></div>
            ...
            <input class="btn" name="gateway_save" type="submit" form="gateway_add" value="<?php echo $Modules->get_translate_module_phrase('module_page_lk_impulse','_AddGateways')?>">
        </div>
    </div>
</div>
<?php endif?>
