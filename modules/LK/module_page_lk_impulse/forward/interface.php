                    ...
                    <div class="col-10 col-md-8 align-center">
                        ...
                        <?php if(!empty($Gateways)):
                                ...
                                <?php foreach($Gateways as $info):?>
                                    ...
                                    <label for="Gateway<?=$info['id']?>" style="background: url('<?php echo MODULES ?>module_page_lk_impulse/assets/gateways/<?php echo mb_strtolower($info['name_kassa'])?>.svg') no-repeat;background-position: center;" class="gateways-label"></label>
