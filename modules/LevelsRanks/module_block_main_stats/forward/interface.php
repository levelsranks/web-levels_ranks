    ...
    <div class="col-md-4 col-fixed">
        <div class="card">
            <div class="card-block-big">
                ...
                <div class="info"><?php echo $Modules->get_translate_module_phrase( 'module_block_main_stats', '_Total_players' ) ?></div>
    ...
    <div class="col-md-4 col-fixed">
        <div class="card">
            <div class="card-block-big">
                ...
                <div class="info"><?php echo $Modules->get_translate_module_phrase( 'module_block_main_stats', '_Players_24_hours' ) ?></div>
    ...
    <div class="col-md-4 col-fixed">
        <div class="card">
            <div class="card-block-big">
                ...
                <div class="info"><?php echo $Modules->get_translate_phrase( '_Headshot' ) ?></div>
