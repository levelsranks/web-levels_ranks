            ...
            <form id="options_one" enctype="multipart/form-data" method="post">
                ...
                <div class="input-form"><div class="input_text"><?php echo $Translate->get_translate_module_phrase( 'module_page_adminpanel','_Show_avatars')?></div>
                    <select name="avatars">
                        ...
                        <option value="input-form"><div class="input_text"><?php echo $Translate->get_translate_module_phrase('module_page_adminpanel', '_Value_Status_1') ?></option>
                        <option value="input-form"><div class="input_text"><?php echo $Translate->get_translate_module_phrase('module_page_adminpanel', '_Value_Status_2') ?></option>
                        <option value="input-form"><div class="input_text"><?php echo $Translate->get_translate_module_phrase('module_page_adminpanel', '_Value_Status_0') ?></option>
                    </select>
                </div>
...
<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-container">
            ...
            <div class="input-form"><div class="input_text"><?php echo $Translate->get_translate_module_phrase( 'module_page_adminpanel','_White_color_palettes')?></div>
            ...
            <div class="input-form"><div class="input_text"><?php echo $Translate->get_translate_module_phrase( 'module_page_adminpanel','_Dark_color_palettes')?></div>
            ...
            <div class="input-form">
                ...
                <label class="border-checkbox-label" for="dark_mode"><?php echo $Translate->get_translate_module_phrase( 'module_page_adminpanel','_Dark_mode_default')?></label>
            </div>
            <div class="input-form">
                ...
                <label class="border-checkbox-label" for="disable_palettes_change"><?php echo $Translate->get_translate_module_phrase( 'module_page_adminpanel','_Disable_palettes_change')?></label>
            </div>
            <div class="input-form">
